...
from app.routers import bots, chat, events, group_moderation, group_verification, library_delivery, qqbot
from app.services.log_retention import install_log_retention

settings = get_settings()
install_log_retention()
app = FastAPI(title="QQ Bot Admin Starter API", version="0.5.0")
app.add_middleware(
    CORSMiddleware,
